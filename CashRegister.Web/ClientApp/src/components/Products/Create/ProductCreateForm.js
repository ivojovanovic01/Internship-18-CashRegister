...
import { getProductTaxTypeEnumValues, isProductNonValid } from "./../../../utils/product";
  ...
  render() {
    ...
    return (
      <div className="create-product-form">
        ...
        />
        <ProductSubmitBtn product={product} handleClick={handleClick} isProductNonValid={isProductNonValid} />
      </div>
    );
  }
}
